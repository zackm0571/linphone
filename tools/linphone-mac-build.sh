#!/bin/bash
# Note: This script is idempotent, and may be run multiple times in succession without issue.

export HOMEBREW_GITHUB_API_TOKEN=${HOMEBREW_GITHUB_API_TOKEN:-$GITHUB_TOKEN}
if [ -z "$HOMEBREW_GITHUB_API_TOKEN" ]; then unset HOMEBREW_GITHUB_API_TOKEN ; fi
